...
|---|---|---|
| **L1** — Workflow automation | Fixed rules, no reasoning | Shipped |
| **L2** — Agentic integration | LLM agents making bounded decisions within a step | Shipped in production |
| **L3** — Adaptive agent loops | Agents evaluating options against SLA data | Designed and deliberately held back until audit trails and permission scopes were safe enough to remove human review |
...
`~85% of legacy functionality removed` · `live build stable; designed the Salesforce data-sync mapping`


**[Strata Design System — Tokens, Components & Storybook](https://sebastianbalderas.com/case-studies/design-system)**


Figma for exploration and client iteration; semantic tokens mapped 1:1 to code, state-driven components, and a versioned Storybook engineering builds from.
...
Most of it comes from **[sebastianbalderas.com](https://sebastianbalderas.com)** — a Next.js site I researched, designed, built, deployed and tested end to end independently, with a conversational AI layer included.
